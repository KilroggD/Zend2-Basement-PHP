 ...
 */
class OrganizationProfile extends \Organization\Entity\OrganizationProfile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Organization\\Entity\\OrganizationProfile' . "\0" . 'id', '' . "\0" . 'Organization\\Entity\\OrganizationProfile' . "\0" . 'name', '' . "\0" . 'Organization\\Entity\\OrganizationProfile' . "\0" . 'shortName', '' . "\0" . 'Organization\\Entity\\OrganizationProfile' . "\0" . 'inn', '' . "\0" . 'Organization\\Entity\\OrganizationProfile' . "\0" . 'kpp', '' . "\0" . 'Organization\\Entity\\OrganizationProfile' . "\0" . 'address', '' . "\0" . 'Organization\\Entity\\OrganizationProfile' . "\0" . 'created', '' . "\0" . 'Organization\\Entity\\OrganizationProfile' . "\0" . 'organization', '' . "\0" . 'Organization\\Entity\\OrganizationProfile' . "\0" . 'type');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrganizationProfile $proxy) {
